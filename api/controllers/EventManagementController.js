...
var mongoose = require('mongoose'), eventManagement = mongoose.model('EventManagement'), eventPhoto = mongoose.model('EventPhotos'), path = require('path'), fs = require('fs');
...
exports.searchEvent = function (req, res) {
    var fieldName = req.params.eventFieldname, regex = new RegExp(req.params.eventSearchvalue, 'i'), query = {};
...
exports.uploadEventPhotos = function (req, res) {
    var extension, newEvent, guid, eventDir = ('./Photos/Event');
