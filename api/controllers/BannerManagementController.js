var mongoose = require('mongoose'), banner = mongoose.model('BannerManagement'), bannerPhoto = mongoose.model('BannerPhoto'), path = require('path'), fs = require('fs'), config = require('../../Config'), moment = require('moment');
var randomNumber = require("crypto");
...
exports.createBanner = function (req, res) {
    var newBanner = new banner(req.body), extension, newPhoto, guid, BannerDir = ('./Photos/Banners');
...
exports.updateBanner = function (req, res) {
    var date = new Date, GUID = randomNumber.randomBytes(16).toString("hex"), extension, newPhoto, Photos = false;
...
//# sourceMappingURL=BannerManagementController.js.map