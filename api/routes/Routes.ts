...
module.exports = function (app) {
    ...
    var committeeList = require('../controllers/committeeMemberController'),
        events = require("../controllers/EventManagementController"),
        login = require('../controllers/LoginController'),
        userModule = require('../controllers/UserModuleController'),
        advertisement = require('../controllers/AdvertisementController'),
        banner = require('../controllers/BannerManagementController'),
        clientSideController = require('../controllers/ClientSideController'),
        cors = require('cors');
